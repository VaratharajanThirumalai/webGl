var Fungi = (function(){
	...
	var	gl = null,
		...
		SAMPLE_ALPHA_COV_STATE = false;//NEW
	...
	*/
	...
	class Material{
		...
		constructor(){
			...
			this.useSampleAlphaCoverage = false;//NEW
	...
	var Renderer = (function(){
		...
		f.prepareNext = function(itm){
			...
			if(f.material !== itm.material){
				...
				if(f.material.useSampleAlphaCoverage != SAMPLE_ALPHA_COV_STATE) gl[ ( (SAMPLE_ALPHA_COV_STATE = (!SAMPLE_ALPHA_COV_STATE)) )?"enable":"disable" ]
				(gl.SAMPLE_ALPHA_TO_COVERAGE);//NEW
			}
