...
function GLInstance(canvasID){
	...
	gl.fCreateMeshVAO = function(name,aryInd,aryVert,aryNorm,aryUV){
		...
		if(aryVert !== undefined && aryVert != null){
			...
			// index: number, size: number, type: number, normalized: boolean, stride: number, offset: number										//Enable Attribute location
	...
	gl.fLoadTexture = function(name,img,doYFlip){
		...
		//texImage2D= two-dimensional texture image													//Set text buffer for work
